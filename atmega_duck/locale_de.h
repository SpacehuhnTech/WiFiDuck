...
// Modifier(s), Key
const uint8_t locale_de[256*2] PROGMEM = {
    ...
    // 160, 0xa0
    KEY_NONE,       KEY_SPACE,      // Nonbreaking space
    KEY_NONE,       KEY_NONE,       // ó
    KEY_NONE,       KEY_NONE,       // ú
    KEY_NONE,       KEY_NONE,       // ñ
    ...
    // 196, 0xc4
    KEY_MOD_LSHIFT, KEY_APOSTROPHE, // Ä
    KEY_NONE,       KEY_NONE,       // ┼
    KEY_NONE,       KEY_NONE,       // ╞
    KEY_NONE,       KEY_NONE,       // ╟
    ...
    KEY_NONE,       KEY_NONE,       // ╘
    KEY_NONE,       KEY_NONE,       // ╒
    KEY_MOD_LSHIFT, KEY_SEMICOLON,  // Ö
    KEY_NONE,       KEY_NONE,       // ╫
    ...
    // 220, 0xdc
    KEY_MOD_LSHIFT, KEY_LEFTBRACE,  // Ü
    KEY_NONE,       KEY_NONE,       // ▌
    KEY_NONE,       KEY_NONE,       // ▐
    KEY_NONE,       KEY_MINUS,      // ß
    ...
    // 252, 0xfc
    KEY_NONE,       KEY_LEFTBRACE,  // ü
    KEY_NONE,       KEY_NONE,       // ²
    KEY_NONE,       KEY_NONE,       // ■
    KEY_NONE,       KEY_NONE        //
};

// utf8, utf8, utf8, utf8, modifier(s), key
const uint8_t utf8_de[8*6] PROGMEM = {
